...
public class JhipsterRhApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterRhApp.class);

    private final Environment env;

    public JhipsterRhApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterRH.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterRhApp.class);
